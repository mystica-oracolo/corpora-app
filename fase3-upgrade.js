    ...
    window.renderWo=function(){
      ...
      <div class="home-dash">
        ...
        <div class="meal-grid">
          ...
          <div class="meal-btn pran" data-ico="📈" onclick="snd();showStoricoCarichiMenu()" style="padding:18px 14px 14px;gap:0;align-items:flex-start;min-height:92px"><div class="meal-lbl" style="font-size:10.5px;font-weight:700;text-align:left">Storico Carichi</div></div>
        </div>
      </div>
